 ...
 * **1** Clone the [custom Renode](https://github.com/bitcraze/renode) repository and check out to the _crazyflie_ branch. Double check the submodule src/Infrastructure (see `.gitmodule`) for the renode repository should have url `https://github.com/bitcraze/renode-infrastructure.git`
