...
if __name__ == "__main__":
  ...
  axs[0].plot(min_plot.time, min_plot.estimated_position_x, 'b', linestyle = 'dashed')
  axs[0].plot(avg_plot.time, avg_plot.estimated_position_x, 'b:')
  axs[0].plot(max_plot.time, max_plot.estimated_position_x, 'b', linestyle = 'dashed')
  ...
  axs[1].plot(min_plot.time, min_plot.estimated_position_y, 'g', linestyle = 'dashed')
  axs[1].plot(avg_plot.time, avg_plot.estimated_position_y, 'g:')
  axs[1].plot(max_plot.time, max_plot.estimated_position_y, 'g', linestyle = 'dashed')
  ...
  axs[2].plot(min_plot.time, min_plot.estimated_position_z, 'r', linestyle = 'dashed')
  axs[2].plot(avg_plot.time, avg_plot.estimated_position_z, 'r:')
  axs[2].plot(max_plot.time, max_plot.estimated_position_z, 'r', linestyle = 'dashed')
